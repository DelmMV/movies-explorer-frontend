...
export const createMovie = (wholeMovie) => {
  return fetch(`${BASE_URL}/movies`, {
    ...
    body: JSON.stringify({
      ...
      image: MOVIE_API_PATH_FOR_THUMBNAIL + wholeMovie.image.url,
      trailerLink: wholeMovie.trailerLink,
      thumbnail:
        MOVIE_API_PATH_FOR_THUMBNAIL + wholeMovie.image.formats.thumbnail.url,
