...
function ProfileContent({ onUpdate, onSignOut, errorText }) {
  ...
  useEffect(() => {
    if (
      inputControl.values.name === currentUser.name &&
    ...
    <section className="profile-content">
      ...
      <form className="profile-content__form">
        <label className="profile-content__label">
          ...
          <input
            className={`profile-content__input ${
              inputControl?.errors?.name && "profile-content__input_error"
            }`}
            name="name"
        ...
        <label className="profile-content__label">
          ...
          <input
            className={`profile-content__input profile-content__input_no-border-bottom ${
              inputControl?.errors?.email && "profile-content__input_error"
            }`}
            name="email"
        ...
        <p
          className={`profile-content__message ${
            errorText.startsWith("Изменение ")
              ? ""
              : "profile-content__message_error"
          }`}
        >
          {errorText}
        </p>
      ...
      <ul
        className={`profile-content__list ${
          isUnlocked && "profile-content__invisible"
        }`}
      >
        ...
        <li className="profile-content__list-item">
          <button
            className="profile-content__button profile-content__button_logout"
            onClick={onSignOut}
          >
            Выйти из аккаунта
          </button>
