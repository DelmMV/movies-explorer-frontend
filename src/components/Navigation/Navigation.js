	...
	return (<>
						...
						{isMobile ? (
								...
								<nav className="navigation navigation-dextop">
									<div className="navigation__left">
										<NavLink to="/movies">
											<button
													className={`navigation__button button ${isVisited ? '' : 'button_disactive-text'}`}>Фильмы
											</button>
										</NavLink>
										<NavLink to="/saved-movies">
											<button
													className={`navigation__button button ${isVisited ? 'button_disactive-text' : ''}`}>Сохраненные
												фильмы
											</button>
										</NavLink>
									</div>
		...
		< div className={`burger-menu ${isBurgerOpen ? 'burger-menu_opened' : ' '}`}>
			<div className='burger-menu__container'>
				<button className="burger-menu__close-btn" onClick={handleCloseBurger}/>
				...
				<NavLink to="/profile" className="burger-menu__link burger-menu__link_type_account">Аккаунт</NavLink>
			</div>
		</div>
